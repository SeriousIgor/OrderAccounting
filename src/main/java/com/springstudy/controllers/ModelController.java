...
public class ModelController {
    ...
    @GetMapping("/all")
    public ResponseEntity<Collection<Optional<Object>>> getRecords(@RequestParam(value = "pageNumber", required = false) Integer pageNumber,
    ...
    @GetMapping("/deleted")
    public ResponseEntity<Collection<Optional<Object>>> getDeletedRecords(@RequestParam(value = "pageNumber", required = false) Integer pageNumber,
