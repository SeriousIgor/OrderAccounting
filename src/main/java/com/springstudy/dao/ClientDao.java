...
public interface ClientDao {
    ...
    String GET_CLIENTS = "SELECT * FROM Clients WHERE isDeleted = 0 OFFSET ? LIMIT ?";

    String GET_CLIENTS_BY_NAME = "SELECT * FROM Clients WHERE isDeleted = 0 AND (fistName LIKE %?% OR lastName LIKE %?%) OFFSET ? LIMIT ?";

    String GET_DELETED_CLIENTS = "SELECT * FROM Clients WHERE isDeleted = 1 OFFSET ? LIMIT ?";
    ...
    String DELETE_CLIENT_SOFT = "UPDATE Clients SET isDeleted = 1 WHERE clientId = ?";
